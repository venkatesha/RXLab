...
public class ListenableFutureAsyncController {
    ...
    DeferredResult<String> home() {
        ...
        final DeferredResult<String> result = new DeferredResult<String>(5000L);

        // Let's call the backend
        ListenableFuture<ResponseEntity<String>> future = restTemplate.getForEntity("http://www.google.com",
                String.class);
